...
* Install latest OpenSSL version on every node
...
* Download netty-tcnative 1.1.33.Fork13 .jar for **your** platform 
 * http://repo1.maven.org/maven2/io/netty/netty-tcnative/1.1.33.Fork13/version, where version is one of `_linux-x86.jar_`, `_64-fedora.jar_`, `_osx-x86_64.jar_`
...
[INFO ][com.floragunn.searchguard.ssl.SearchGuardKeyStore] Open SSL ALPN supported true
</pre>
